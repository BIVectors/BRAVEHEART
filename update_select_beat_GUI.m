...
% update_select_beat_GUI.m -- Part of BRAVEHEART GUI - Updates beat annotations
...
function update_select_beat_GUI(hObject, eventdata, handles)
...
beats = beats.change(str_index,line_str);
