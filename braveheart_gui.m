...
% Adjust GUI appearance if on Mac
if ismac
...
' ' ;...
'This software is for research puropses only and is not intended' ;...
...
figure(figure('name','Angle Orientation','numbertitle','off'))
%angles = imread(fullfile(getcurrentdir(),'angles.png')); 
angles = imread('angles.png'); 
imshow(angles);
...
ecg_raw.write(strcat(filename,'.txt'), 'unformatted', freq);
