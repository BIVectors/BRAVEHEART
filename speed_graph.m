...
% speed_graph.m -- Part of BRAVEHEART GUI - Shows speed figure
...
function speed_graph(hObject, eventdata, handles, filename, save_flag, auto_flag, blank_samples, accel_flag)
...
%%# save
if save_flag == 1
 print(gcf,'-dpng',[fullfile(save_folder,filename) '.png'],'-r600');
end
